 ...
 <!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<c:url value="/"/>">AKAGUNDUZ ADMIN</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" >
                    ...
                    <li ng-class="{'active': activeURL == 'users', '': activeURL != 'users'}">
                        <a href="javascript:;" data-toggle="collapse" data-target="#categoryTab"><i class="glyphicon glyphicon-tasks"></i> Users <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="categoryTab" class="collapse">
                            <li>
                                <a href="<c:url value='/protected/users'/>">All User</a>
                            </li>
                        </ul>
                    </li>
